...
public class LayoutVisitor implements Visitor {
  ...
  public Object visitRepeatTimesCommand(RepeatTimesCommand ast, Object obj) {
    return layoutBinary("RepeatTimesCom.", ast.E, ast.C);
  }
  ...
  public Object visitSkipCommand(SkipCommand ast, Object obj) { //Skip layout - Alonso
    return layoutNullary("SkipCom.");
  }
  ...
  public Object visitForDo(ForDo ast, Object o) { //ForDo layout - Raquel
      return layoutTernary("ForDoCom.", ast.IE, ast.E, ast.C);
  }
    
  public Object visitForWhile(ForWhile ast, Object o) { //ForWhile layout - Raquel
      return layoutQuaternary("ForWhileCom.", ast.IE, ast.E1, ast.E2, ast.C);
  }

  public Object visitForUntil(ForUntil ast, Object o) { //ForUntil layout - Raquel
      return layoutQuaternary("ForUntilCom.", ast.IE, ast.E1, ast.E2, ast.C);
  }

  public Object visitForIn(ForIn ast, Object o) { //ForIn layout - Raquel
      return layoutBinary("ForInCom.", ast.IE, ast.C);
  }

  public Object visitSelect(Select ast, Object o) { //Select layout - Raquel
    if (ast.Co == null) return(layoutBinary("SelectCom", ast.E, ast.Ca));
    else return(layoutTernary("SelectCom", ast.E, ast.Ca, ast.Co));
  }
...
//Mariángeles
  ...
  public Object visitVarDeclarationExpression(VarDeclarationExpression ast, Object o) {
    return layoutBinary("VarDeclExp.", ast.I, ast.E);
  }  
  
  public Object visitRec(Rec ast, Object o) { //Rec layout - Raquel
    return layoutUnary("RecExp.", ast.PF);
  }
  
  public Object visitPrivate(Private ast, Object o) { //Private layout - Raquel
    return layoutBinary("privateExp.", ast.D1, ast.D2);
  }
  ...
  public Object visitDotVname(DotVname ast, Object obj) {
    return layoutBinary("DotVname", ast.V, ast.I);
  }
  ...
  public Object visitSubscriptVname(SubscriptVname ast, Object obj) {
    ...
    public Object visitIdentifierVarname(IdentifierVarname ast, Object o) {
        return layoutBinary("Ident.Vname",ast.I, ast.V);
    }

    public Object visitSimpleVarname(SimpleVarname ast, Object o) {
        return layoutUnary("Sim.Varname", ast.V);
    }
