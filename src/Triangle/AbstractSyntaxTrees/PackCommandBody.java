...
public class PackCommandBody extends Body {

  public PackCommandBody (PackageDeclaration pAST,Command cAST, SourcePosition thePosition) {
    super (thePosition);
    C = cAST;
    P = pAST;
  }
    ...
    public Object visit(Visitor v, Object o) {
        return v.visitPackCommandBody(this, o);
    }
